...
const countdownButtomEl=document.getElementById('countdown-button');
const timeEl=document.querySelectorAll('span'); // ดึงแท็ก span มา
...
countdownButtomEl.addEventListener('click',reset);
